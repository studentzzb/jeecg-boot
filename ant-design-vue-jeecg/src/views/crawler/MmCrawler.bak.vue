  ...
  <a-card :bordered="false" class="card-area">
    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="爬取ID段">
              <a-input placeholder="起始ID" v-model="queryParam.start" style="width:calc(50% - 15px);"></a-input>
              <span class="group-query-strig">~</span>
              <a-input placeholder="结束ID" v-model="queryParam.end" style="width:calc(50% - 15px);"></a-input>
            </a-form-item>
          </a-col>
<!--          <a-col :md="10" :sm="12">-->
